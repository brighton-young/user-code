...
var PermissionsDefinitionBuilder = (function () {
  ...
  PermissionsDefinitionBuilder.prototype.withPermissions = function (
    permissions
  ) {
...
angular.module("wixAngularBackwardCompatibility", [
  "wixAngularAppInternal",
  "wixAngularExperiments",
]);

angular.module("wixAngularAppInternal", ["nr-ng-client"]);

angular.module("wixAngularInterceptor", ["wixAngularAppInternal"]).config([
  "$httpProvider",
  "wixAngularTopologyProvider",
  function ($httpProvider, wixAngularTopologyProvider) {
    $httpProvider.interceptors.push("wixAngularInterceptor");
    if (!wixAngularTopologyProvider.getStaticsUrl()) {
      wixAngularTopologyProvider.setStaticsUrl(
        angular.element(document).find("base").attr("href")
      );
    }
  },
]);
...
angular.module("wixAngular", [
  "wixAngularAppInternal",
  "wixAngularTranslateCompile",
  "wixAngularExperiments",
  "wixAngularInterceptor",
  "wixAngularBackwardCompatibility",
  "wixAngularPermissions",
  "wixAngularConstants",
]);

angular
  .module("wixAngularConstants")
  .constant(
    "letterUnicode",
    "A-Za-zªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-" +
      "ˤˬˮͰ-ʹͶͷͺ-ͽΆΈ-ΊΌΎ-ΡΣ-ϵϷ-" +
      "ҁҊ-ԧԱ-Ֆՙա-ևא-תװ-ײؠ-يٮٯٱ-ۓ" +
      "ەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺ" +
      "ࠀ-ࠕࠚࠤࠨࡀ-ࡘࢠࢢ-ࢬऄ-हऽॐक़-ॡॱ-ॷॹ-" +
      "ॿঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰ" +
      "ৱਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-" +
      "ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡଅ-ଌ" +
      "ଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊ" +
      "எ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-" +
      "ఐఒ-నప-ళవ-హఽౘౙౠౡಅ-ಌಎ-ಐಒ-ನಪ-" +
      "ಳವ-ಹಽೞೠೡೱೲഅ-ഌഎ-ഐഒ-ഺഽൎൠൡൺ-" +
      "ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄ" +
      "ງຈຊຍດ-ທນ-ຟມ-ຣລວສຫອ-ະາຳຽເ-" +
      "ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥ" +
      "ၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-" +
      "ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕ" +
      "ጘ-ፚᎀ-ᎏᎠ-Ᏼᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᜀ-ᜌᜎ-ᜑᜠ-ᜱ" +
      "ᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡷᢀ-ᢨᢪᢰ-ᣵᤀ-ᤜᥐ-" +
      "ᥭᥰ-ᥴᦀ-ᦫᧁ-ᧇᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭋᮃ-ᮠᮮᮯ" +
      "ᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᳩ-ᳬᳮ-ᳱᳵᳶᴀ-ᶿḀ-ἕἘ-Ἕ" +
      "ἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌ" +
      "ῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕℙ-" +
      "ℝℤΩℨK-ℭℯ-ℹℼ-ℿⅅ-ⅉⅎↃↄⰀ-Ⱞⰰ-ⱞⱠ-" +
      "ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶ" +
      "ⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞⸯ々〆〱-〵〻〼ぁ-ゖゝ-" +
      "ゟァ-ヺー-ヿㄅ-ㄭㄱ-ㆎㆠ-ㆺㇰ-ㇿ㐀-䶵一-鿌ꀀ-ꒌꓐ-" +
      "ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚗꚠ-ꛥꜗ-ꜟꜢ-ꞈꞋ-ꞎꞐ-" +
      "ꞓꞠ-Ɦꟸ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꤊ-ꤥ" +
      "ꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꪀ-ꪯꪱꪵ" +
      "ꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-" +
      "ꬮꯀ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨ" +
      "שׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-" +
      "ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ"
  )
  .constant(
    "numberUnicode",
    "0-9²³¹¼-¾٠-٩۰-۹߀-߉०-९০-৯৴-৹" +
      "੦-੯૦-૯୦-୯୲-୷௦-௲౦-౯౸-౾೦-೯൦-൵๐-๙" +
      "໐-໙༠-༳၀-၉႐-႙፩-፼ᛮ-ᛰ០-៩៰-៹᠐-᠙᥆-᥏" +
      "᧐-᧚᪀-᪉᪐-᪙᭐-᭙᮰-᮹᱀-᱉᱐-᱙⁰⁴-⁹₀-₉⅐-" +
      "ↂↅ-↉①-⒛⓪-⓿❶-➓⳽〇〡-〩〸-〺㆒-㆕㈠-㈩㉈-" +
      "㉏㉑-㉟㊀-㊉㊱-㊿꘠-꘩ꛦ-ꛯ꠰-꠵꣐-꣙꤀-꤉꧐-꧙꩐-" +
      "꩙꯰-꯹０-９"
  )
  .constant("dashPunctuationUnicode", "-֊־᐀᠆‐-―⸗⸚⸺⸻〜〰゠︱︲﹘﹣－");
...
angular
  .module("wixAngularPermissionsConstants")
  .constant("wixRoles", new WixRoles());
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        function compileTranslation() {
          var values = attrs.translateValues
            ? $parse(attrs.translateValues)(scope)
            : {};
...
(function () {
      ...
      link: function (scope, element, attr) {
        attr.$observe("relativeSrc", function (url) {
          if (url) {
            attr.$set(
              "src",
              shouldSetStatics(url) ? wixAngularTopology.staticsUrl + url : url
            );
          }
        });
      },
  ...
  function shouldSetStatics(url) {
    return (
      url &&
      ["images/", "bower_components", "assets/images/"].some(function (path) {
  ...
  angular
    ...
    .directive("ngSrc", ngSrc);
})();

("use strict");

(function () {
  wixManagersNgDirective.$inject = [
    "manager",
    "ngDirective",
    "directiveName",
    "ngAttributeName",
  ...
  function wixManagersNgDirective(
    manager,
    ngDirective,
    directiveName,
    ngAttributeName,
  ...
  angular.module("wixAngularExperiments").directive("wixExperimentIf", [
    "$injector",
    "experimentManager",
    "ngIfDirective",
    function ($injector, experimentManager, ngIfDirective) {
      return defineNgDirective(
        $injector,
        experimentManager,
        "wixExperimentIf",
        ngIfDirective,
  ...
  angular.module("wixAngularPermissions").directive("wixPermissionIf", [
    "$injector",
    "permissionsManager",
    "ngIfDirective",
    function ($injector, permissionsManager, ngIfDirective) {
      return defineNgDirective(
        $injector,
        permissionsManager,
        "wixPermissionIf",
  ...
  angular.module("wixAngularExperiments").directive("wixExperimentDisabled", [
    "$injector",
    "experimentManager",
    "ngDisabledDirective",
    function ($injector, experimentManager, ngDisabledDirective) {
      return defineNgDirective(
        $injector,
        experimentManager,
        "wixExperimentDisabled",
        ngDisabledDirective,
        "ngDisabled"
      );
    },
  ]);
  angular.module("wixAngularPermissions").directive("wixPermissionDisabled", [
    "$injector",
    "permissionsManager",
    "ngDisabledDirective",
    function ($injector, permissionsManager, ngDisabledDirective) {
      return defineNgDirective(
        $injector,
        permissionsManager,
        "wixPermissionDisabled",
        ngDisabledDirective,
        "ngDisabled"
      );
    },
...
(function () {
  ...
  angular.module("wixAngularExperiments").directive("wixExperimentClass", [
    "$injector",
    "experimentManager",
    function ($injector, experimentManager) {
      return defineClassDirective(
        $injector,
        experimentManager,
        "wixExperimentClass",
        "experimentValues"
  ...
  angular.module("wixAngularPermissions").directive("wixPermissionClass", [
    "$injector",
    "permissionsManager",
    function ($injector, permissionsManager) {
      return defineClassDirective(
        $injector,
        permissionsManager,
        "wixPermissionClass",
...
(function () {
  wixMailValidator.$inject = [
    "letterUnicode",
    "numberUnicode",
    "dashPunctuationUnicode",
  ];
  function wixMailValidator(
    ...
    var EMAIL_LOCAL_PART_REGEX =
      ALL_VALID_CHARS_EXCEPT_DOT +
      "([" +
      N +
      L +
      Pd +
      "._+/!#$%&'*=?^`{}|~])*" +
      ALL_VALID_CHARS_EXCEPT_DOT;
    var EMAIL_DOMAIN_REGEX =
      "[0-9a-zA-Z]+([-.]+[0-9a-zA-Z]+)*([0-9a-zA-Z]*[.])[a-zA-Z]{2,63}";
      ...
      link: function (scope, elm, attrs, ctrl) {
        if (attrs["wixMailValidator"] !== "false") {
          ctrl.$parsers.unshift(function (viewValue) {
            if (
              !viewValue ||
              (EMAIL_REGEXP.test(viewValue) &&
                domainValidator.isValid(getDomainPart(viewValue)))
            ) {
  ...
  angular
    .module("wixAngularAppInternal")
    .directive("wixMailValidator", wixMailValidator);
})();

("use strict");

(function () {
  angular.module("wixAngularAppInternal").factory("wixConstValue", [
    "$injector",
    function ($injector) {
      return function (name) {
        var constantValueOrName = $injector.has(name)
          ? $injector.get(name)
          : name;
...
(function () {
  wixAngularInterceptorFactory.$inject = [
    "$q",
    "wixCookies",
    "$rootScope",
    "wixAngularEvents",
  ...
  function wixAngularInterceptorFactory(
    $q,
    wixCookies,
    $rootScope,
    wixAngularEvents,
      ...
      if (config.url.match(/\.(?:html|svg)$/)) {
        if (!config.url.match(/(:|^)\/\//)) {
          if (
            ...
            config.url =
              wixAngularTopology.calcPartialsUrl(
                wixAngularTopology.staticsUrl
              ) + config.url.replace(/^\//, "");
          }
        }
        ...
        if (
          ...
          $injector
            ...
            .isExperimentEnabled("specs.wos.CachBustingAPI")
        ) {
          config.url = addSearch(
            config.url,
            "cb339",
            generateCacheBustingValue(config.cache, config.url)
          );
        }
        ...
        if (
          checkParameters(
            wixAngularTopology.language,
            wixAngularTopology.linguistInstance,
            wixAngularTopology.locale,
            wixAngularTopology.isPrimaryLanguage
          )
        ) {
          config.headers["x-wix-linguist"] = [
            wixAngularTopology.language,
            wixAngularTopology.locale,
            wixAngularTopology.isPrimaryLanguage,
            wixAngularTopology.linguistInstance,
    ...
    wixAngularInterceptor.response = function (response) {
      if (response.data) {
        if (response.data.success === false) {
          ...
          if (
            angular.isObject(response.data.payload) &&
            !angular.isArray(response.data.payload)
          ) {
...
(function () {
  ...
  function WixAngular(
    ...
    var isExperimentEnabled =
      experimentManagerProvider.isExperimentEnabled.bind(
        experimentManagerProvider
      );
    this.setExperiments = experimentManagerProvider.setExperiments.bind(
      experimentManagerProvider
    );
    ...
    this.$get = [
      "wixAngularTopology",
      "experimentManager",
      function (wixAngularTopology, experimentManager) {
        var wixAngular = {};
  ...
  function WixAngularTopology($sceDelegateProvider, nrNgClientProvider) {
    ...
    this.$get = [
      ...
      function ($window, $document, $location) {
        var origin =
          $document.find && $document.find("base").attr("href")
        ...
        var encodedInstance =
          linguistInstance && linguistInstance.split(".")[1];
        var instanceId;
        try {
          instanceId =
            encodedInstance &&
            JSON.parse($window.atob(encodedInstance)).instanceId;
        } catch (e) {}
...
window.loadExperimentScopeSync = function (scope) {
  var url =
    "//www.wix.com/_api/wix-laboratory-server/laboratory/conductAllInScope?scope=" +
    scope +
    "&accept=jsonp&callback=setExperimentsSync";
...
var ExperimentManager = (function () {
  ...
  ExperimentManager.prototype.getPetriUrl = function (params) {
    return (
      this.petriUrlPrefix +
      (params.scope ? "conductAllInScope/" : "conductExperiment/")
    );
  };
...
angular
  ...
  .run([
    "$rootScope",
    "experimentManager",
    function ($rootScope, experimentManager) {
...
if (window.beforeEach) {
  window.beforeEach(function () {
    angular.module("experimentManagerMock").config([
      "experimentManagerProvider",
      function (experimentManagerProvider) {
...
angular.module("experimentManagerMock", []).config([
  "$provide",
  function ($provide) {
    $provide.decorator("experimentManager", [
      "$delegate",
      "$q",
      function ($delegate, $q) {
        var originalGetExperimentValue =
          $delegate.getExperimentValue.bind($delegate);
        var originalIsExperimentEnabled =
          $delegate.isExperimentEnabled.bind($delegate);
        ...
        function resolvePromise(params) {
          ...
          if (params.scope) {
            ...
            deferred.resolve(
              Object.keys(scopeToExperiments).reduce(function (prev, scope) {
        ...
        $delegate.verifyNoUnusedExperiments = function () {
          var unused = Object.keys($delegate.$$getExperimentsObj()).filter(
            function (experiment) {
...
var PermissionsManager = (function () {
  ...
  function PermissionsManager(provider, wixRoles) {
    ...
    this.permissionsContextMap[this.defaultContextKey] =
      this.provider.permissionsDefinition;
  }
  PermissionsManager.prototype.contains = function (value, context) {
    ...
    return permissionsDefinition
      ? this.hasPermission(permissionsDefinition, value)
      : false;
  };
  ...
  PermissionsManager.prototype.assignPermissionsMap = function (
    permissionsMap
  ) {
  ...
  PermissionsManager.prototype.hasPermission = function (
    permissionsDefinition,
    permission
  ) {
    var isHavePermission =
      permissionsDefinition.permissions.indexOf(permission) !== -1;
...
var PermissionsManagerProvider = (function () {
  ...
  PermissionsManagerProvider.prototype.setAuthorizationInfo = function (
    authorizationInfo
  ) {
    this.permissionsDefinition = new PermissionsDefinition(authorizationInfo);
  };
  PermissionsManagerProvider.prototype.setPermissions = function (
    permissionsDefinition
  ) {
    this.permissionsDefinition = permissionsDefinition;
  };
  PermissionsManagerProvider.prototype.setPermissionsContextMap = function (
    permissionsContextMap
  ) {
...
var IsPermitted = (function () {
  ...
  IsPermitted.prototype.filter = function (
    input,
    permissionId,
    fallback,
    context
  ) {
    var result = this.wixManagerEval.eval(
...
angular.module("wixAngularPermissions").filter("isPermitted", [
  "$injector",
  function ($injector) {
...
angular
  .module("wixAngularAppInternal")
  .service("wixManagerEval", WixManagerEval);

("use strict");

angular
  .module("wixAngularAppInternal")
  .value("angularVersion", angular.version)
  .factory("cookieReaderFacade", [
    "$injector",
    "$browser",
    "angularVersion",
    function ($injector, $browser, angularVersion) {
...
var WixHeightWatcher = (function () {
  ...
  WixHeightWatcher.prototype.reportHeight = function (height) {
    ...
    this.$rootScope.$apply(function () {
      return _this.$rootScope.$emit(
        WixHeightWatcherModule.HEIGHT_CHANGED_EVENT,
        height
      );
    });
  };
...
angular
  .module("wixAngularAppInternal")
  .service("wixHeightWatcher", WixHeightWatcher);

("use strict");

var WixTpaHeightChangedDirectiveCtrl = (function () {
  WixTpaHeightChangedDirectiveCtrl.$inject = [
    "$scope",
    "wixHeightWatcher",
    "$window",
  ];
...
angular
  .module("wixAngularAppInternal")
  .directive("wixTpaHeightChanged", function () {
    return {
      restrict: "A",
...
angular
  .module("wixAngularAppInternal")
  .directive("wixHeightChanged", function () {
    return {
...
angular.module("wixAngularAppInternal").run([
  "$injector",
  "$locale",
  "$log",
  "$window",
  function ($injector, $locale, $log, $window) {
    var translationLanguage =
      $injector.has("preferredLanguage") && $injector.get("preferredLanguage");
