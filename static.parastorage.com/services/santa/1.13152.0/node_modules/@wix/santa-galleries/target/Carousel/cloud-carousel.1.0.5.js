...
(function ($) {
  ...
  var Controller = function (container, images, options) {
    ...
    this.rotate = function (direction) {
      ...
      this.frontIndex =
        this.frontIndex < 0 ? items.length + this.frontIndex : this.frontIndex;
    ...
    this.updateAll = function () {
      ...
      var minScale = 0.9 / itemsLen; //options.minScale;	// This is the smallest scale applied to the furthest item.
