(() => {
        ...
        const t = e.tag,
          ...
          i = (function (e, t, n, o) {
            ...
            const a = () => {
              ...
              d = () => {
                (r -= 1), r >= 0 && O(t.onerror, { error: !0 });
              },
              c = n.firstChild;
            e.forEach((e) => {
              "SCRIPT" === e.tag && (r += 1);
              const t = L(e, { onload: a, onerror: d });
    ...
    a.open(d, c, !0),
      (a.onreadystatechange = () => {
        if (4 === a.readyState) {
          const e = a.status;
          e < 200 || e >= 300
            ? O(n, { status: e, responseText: a.responseText })
            : O(t, a.responseText);
        }
      }),
  ...
  function k(e, t) {
    const r = o(e),
      { currentPageID: a, initConsentPolicyManager: d = !1 } = t;
    var c, s, l, g;
    if (
      ...
      (l = r.tags),
        i(null == (g = w) ? void 0 : g.experiments, u)
          ? l.forEach((e) => {
              ...
              p.push({ tag: { ...e, loadOnce: n }, embeddedNodes: null });
            })
          : l.forEach((e) => {
              p.push({ tag: e, embeddedNodes: null });
            });
      const e = { id: a };
  ...
  function Y(e) {
    const {
      ...
      p = H("omit"),
      m = window.wixEmbedsAPI.getAppToken;
    m && (g.authorization = O(m, c)),
      U(
        l,
        (e) => {
          k(e, { initConsentPolicyManager: !d && !!r, currentPageID: f.id });
        },
        (e) => {
  ...
  let z = () => {
    ...
    Y({
      ...
      window.wixEmbedsAPI.registerToEvent("pageNavigation", V),
      document.addEventListener("consentPolicyChanged", W),
      (window.wixTagManager = X),
      P(v.TAG_MANAGER_LOADED, window, X);
  };
  window.wixEmbedsAPI &&
