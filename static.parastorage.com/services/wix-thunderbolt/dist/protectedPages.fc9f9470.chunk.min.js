...
(self.webpackJsonp__wix_thunderbolt_app =
  ...
  [5445, 569],
  {
    33615: function (e, t, a) {
      ...
      const i = (0, r.Og)(
        [(0, r.KT)(s._K, o.U), (0, r.KT)(s.YG, o.U), (0, r.KT)(s.wk, o.U)],
        (e, t, a) => {
          const r = (a) => {
          ...
          return {
            async handle(t) {
              ...
              if (o[s]) return { ...t, pageJsonFileName: o[s] };
      ...
      const h = (0, r.Og)(
        ...
        (
          ...
          { customNoPermissionsPageUriSeo: r, customNoPermissionsPageId: s },
          o,
          i,
          g,
          u,
                ...
                ? (async () => {
                    ...
                    if (g)
                      if (P["specs.thunderbolt.newAuthorizedPagesFlow"]) {
                        if (((e = await g.requestAuthorizedPages()), e.success))
                          return {
                        ...
                        ((e = await g.requestAuthentication({})), e.success)
                      )
                        return {
                          authorizedPagesMap:
                            await g.authorizeMemberPagesByToken(e.token),
                        };
          ...
          async function h(t) {
            if (!u) return;
            const { authorizedPagesMap: a, onComplete: n } =
            ...
            e.update((e) => ({
              ...
              await o.navigate(t.parsedUrl.href),
              n?.();
          }
          const f = async (a, n) => {
            const r = a.pageId;
