...
function decorate_20223_$1(mthd, context) {
  ...
  var _createAction = function _createAction(m) {
    ...
    return createAction(
      (_ann$options_$name =
        (_ann$options_ = ann.options_) == null ? void 0 : _ann$options_.name) !=
        null
        ? _ann$options_$name
        : name.toString(),
      m,
      (_ann$options_$autoAct =
        (_ann$options_2 = ann.options_) == null
          ? void 0
          : _ann$options_2.autoAction) != null
        ? _ann$options_$autoAct
        : false
    );
  };
  ...
  function initializeObservable(target, value) {
    ...
    var observable = new ObservableValue(
      ...
      (_ann$options_$enhance =
        (_ann$options_ = ann.options_) == null
          ? void 0
          : _ann$options_.enhancer) != null
        ? _ann$options_$enhance
        : deepEnhancer,
      process.env.NODE_ENV !== "production"
