var t,
  ...
  T = function (t) {
    "hidden" === document.visibilityState &&
      h > -1 &&
      ((h = "visibilitychange" === t.type ? t.timeStamp : 0), E());
  },
  y = function () {
    ...
    if (
      ...
      if (n || B.length < 10 || t.duration > e.latency) {
        ...
        B.sort(function (t, e) {
          ...
          B.length > 10 &&
            B.splice(10).forEach(function (t) {
      ...
      b(function () {
        ...
        var r,
          ...
          a = function (t) {
            t.forEach(O);
            var e,
              n = ((e = Math.min(B.length - 1, Math.floor(H() / 50))), B[e]);
            n &&
              n.latency !== i.value &&
...
N.push(function (t) {
  ...
  n !== e &&
    ...
    (t.interactionId || "first-input" === t.entryType) && G.set(t, n),
    J < 0 && (J = W(Q));
});
var X,
  Y,
        ...
        W(function () {
          !(function (t) {
            var e = t.entries[0],
              ...
              d = [e.startTime + e.duration, u].concat(
                s.map(function (t) {
      ...
      (e = e || {}),
        b(function () {
          ...
          if (o) {
            ...
            var u = v(function () {
              rt[i.id] ||
                (a(o.takeRecords()), o.disconnect(), (rt[i.id] = !0), n(!0));
            });
      ...
      !(function (t) {
        if (t.entries.length) {
          ...
          if (e) {
            ...
            return (
              o.url && (l.url = o.url),
              u && (l.lcpResourceEntry = u),
              void (t.attribution = l)
            );
          }
        }
        t.attribution = {
