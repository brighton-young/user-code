...
const shouldEnforceNoEvalWorkaroundExperiment = (host) =>
  !!host && host === "editor";
...
const isAnonymousDefineFixExperimentOn = (isExperimentOpen) =>
...
export const shouldApplyNoEvalWorkaroundExperiment = (isExperimentOpen, host) =>
  shouldEnforceNoEvalWorkaroundExperiment(host) ||
  (typeof isExperimentOpen !== "undefined" &&
...
export function getEnvironment({ id, globals, host, isExperimentOpen }) {
  ...
  return {
     ...
     */
    exports:
      isServer() && isOriginalRequireFunctionAvailable(isExperimentOpen)
        ? {}
        : undefined,
    /**
     *
...
export async function getModel(id, host, isExperimentOpen) {
  const factory = await getGlobalModel(
    getLazyFactoryID(id),
    host,
    isExperimentOpen
  );
