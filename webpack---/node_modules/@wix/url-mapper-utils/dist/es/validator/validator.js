...
var UrlMapperValidators = /** @class */ (function () {
  function UrlMapperValidators(_a) {
    ...
    this.defaultMapping = getPathPrefixesValidationMapping(
      urlMappingKey,
      this.pathPrefix
    );
    this.initValidators();
  ...
  UrlMapperValidators.prototype.getPathPrefix = function () {
    ...
    var pathPrefix =
      this.pathPrefixes[tpaPageId] || UrlMapperValidators.FALLBACK_PATH_PREFIX;
    return pathPrefix;
  };
  ...
  UrlMapperValidators.prototype.validate = function (value) {
    ...
    try {
      for (
        var _b = __values(this.validators), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
