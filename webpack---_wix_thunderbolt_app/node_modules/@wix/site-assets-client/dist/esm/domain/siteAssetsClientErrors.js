...
function getErrorMessageWithShortUrl(url, cause) {
  ...
  var messageWithShortUrl =
    url && message.includes(url)
      ? message.replace(url, "".concat(url.substring(0, 120), "..."))
      : message;
...
var SiteAssetsServerError = /** @class */ (function (_super) {
  ...
  function SiteAssetsServerError(siteAssetsUrl, cause) {
    var _this =
      _super.call(this, getErrorMessageWithShortUrl(siteAssetsUrl, cause), {
        cause: cause,
      }) || this;
