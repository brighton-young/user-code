...
export var SiteAssetsServerHttpResponseBuilder = function () {
  ...
  var parseCdnProvider = function (httpResponse) {
    ...
    var cdnProvider = (
      last(via === null || via === void 0 ? void 0 : via.split(",")) || ""
    ).toLowerCase();
    if (cdnProvider.includes("google")) return "google";
    if (cdnProvider.includes("cloudfront")) return "cloudfront";
    if (cdnProvider.includes("varnish")) return "fastly";
    return "unknown";
  };
    ...
    return {
      ...
      reportMetrics: function (moduleMetricsReporter, durationMs) {
        ...
        if (cdnHit) {
          ...
          moduleMetricsReporter.meter(
            "".concat(CDN_CACHE_NAME, "-hit-").concat(provider),
            {
