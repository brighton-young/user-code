...
var GraphqlClient = /** @class */ (function () {
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            ...
            if (!(!forcePost && endpoint.includes(Topology.NODE_GRAPHQL_URL)))
              return [3 /*break*/, 2];
            return [
              4 /*yield*/,
              this.tryNodeGetGqlAndFallbackToPost(endpoint, params),
            ];
          case 1:
            response = _e.sent();
            return [3 /*break*/, 6];
          case 2:
            ...
            return [
              4 /*yield*/,
              this.siteStore.httpClient.post(endpoint, params),
            ];
          case 3:
            response = _e.sent();
            return [3 /*break*/, 6];
          case 4:
            return [
              4 /*yield*/,
              this.siteStore.tryGetGqlAndFallbackToPost(endpoint, params),
            ];
          case 5:
            response = _e.sent();
            _e.label = 6;
  ...
  GraphqlClient.prototype.tryNodeGetGqlAndFallbackToPost = function (
    url,
    reqData,
    options
  ) {
