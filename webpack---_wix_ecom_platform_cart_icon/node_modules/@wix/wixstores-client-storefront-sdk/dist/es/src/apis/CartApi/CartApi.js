...
import { query as setCartSelectedShippingOption } from "../../graphql/setCartSelectedShippingOption.graphql";
import { query as setDestinationForEstimation } from "../../graphql/setDestinationForEstimation.graphql";
import { query as addToCartMutation } from "../../graphql/addToCart.graphql";
import { query as setCouponMutation } from "../../graphql/setCoupon.graphql";
import { query as removeCouponMutation } from "../../graphql/removeCoupon.graphql";
import { query as updateBuyerNoteMutation } from "../../graphql/updateBuyerNote.graphql";
import { query as removeCartItemMutationQuery } from "../../graphql/removeCartItem.graphql";
import { query as updateCartItemQuantityQuery } from "../../graphql/updateCartItemQuantity.graphql";
import { query as createVolatileCartQuery } from "../../graphql/createVolatileCart.graphql";
...
var CartApi = /** @class */ (function (_super) {
  ...
  function CartApi(_a) {
    var siteStore = _a.siteStore,
      origin = _a.origin;
    var _this =
      _super.call(this, { siteStore: siteStore, origin: origin }) || this;
  ...
  CartApi.prototype.commandPost = function (command, data) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.post(this.endpoints.cartCommmands(command), data),
        ];
      });
    });
  };
        ...
        switch (_a.label) {
          case 0:
            ...
            inputs.forEach(function (input) {
              ...
              if (
                input.customTextFieldSelections &&
                input.customTextFieldSelections.length > 0
              ) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.mutate({
            variables: { params: { cartId: cartId, buyerNote: buyerNote } },
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.updateBuyerNoteMutation(cart.cartId, data.content),
            ];
          case 1:
            _b.sent();
            if (withBi) {
        ...
        switch (_a.label) {
          case 0:
            return [
              ...
              this.mutate({
                variables: {
                  params: { cartId: cartId, address: data.destination },
                },
  ...
  CartApi.prototype.setShippingOption = function (
    cartId,
  ...
  CartApi.prototype.setCouponMutation = function (
    cartId,
    code,
    userIdentifier
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.setCouponMutation(cartId, code, userIdentifier),
            ];
          case 1:
            cart = _a.sent();
            return [2 /*return*/, graphqlCartToCartSummary(cart)];
        ...
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.mutate({
                variables: { params: { cartId: cartId, couponId: couponId } },
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.commandPost(RestCommands.CartDelete, data),
            ];
          case 1:
            _a.sent();
            void onDelete(data);
