    ...
    return {
      pageReady: function () {
        return Promise.resolve()
            ...
            return Promise.all(
              __spreadArray(
                __spreadArray(
                  [],
                  __read(
                    shouldSkipMultilingual
                      ? []
                      : [
                          handleMultilingual(
                            controllerParams,
                            controller.getFreeTexts()
                          ),
                        ]
                  ),
                  false
          ...
          .then(
            handleLocationChange(controllerParams, function () {
      ...
      updateConfig: function (_$w, updatedConfig) {
        var _a, _b;
        void ((_a = controller.onConfigUpdate) === null || _a === void 0
          ? void 0
          : _a.call(controller, updatedConfig));
        return void ((_b = controller.onStyleUpdate) === null || _b === void 0
          ? void 0
          : _b.call(controller, updatedConfig.style.styleParams));
      },
      updateAppSettings: function (_$w, updates) {
        var _a;
        return void ((_a = controller.onAppSettingsUpdate) === null ||
        _a === void 0
          ? void 0
          : _a.call(controller, updates));
      },
      onBeforeUnLoad: function () {
        var _a;
        return (_a = controller.onBeforeUnLoad) === null || _a === void 0
          ? void 0
          : _a.call(controller);
      },
    };
