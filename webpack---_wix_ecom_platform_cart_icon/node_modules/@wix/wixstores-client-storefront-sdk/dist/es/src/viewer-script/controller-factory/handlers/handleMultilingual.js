...
export function handleMultilingual(controllerParams, freeTextKeys) {
  ...
  return __awaiter(this, void 0, void 0, function () {
    var dangerousPublicDataOverride,
      setProps,
      siteStore,
      appSettingsApi,
      widgetSettings,
      ...
      switch (_b.label) {
        case 0:
          dangerousPublicDataOverride =
            controllerParams.dangerousPublicDataOverride;
          ...
          return [
            4 /*yield*/,
            appSettingsApi.fetchWidgetSettings({
              externalId:
                (_a = controllerParams.controllerConfig.config.externalId) !==
                  null && _a !== void 0
                  ? _a
                  : "",
            }),
        ...
        case 1:
          ...
          multilingualService = new MultilingualService(
            siteStore,
            controllerParams.controllerConfig.config.publicData.APP,
            widgetSettings
          );
          nextPublicData = dangerousPublicDataOverride({
            APP: multilingualService.getMergedTranslationsAsPublicData(
              freeTextKeys
            ),
            COMPONENT: {},
          });
