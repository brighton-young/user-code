export default (function e(t) {
  function r(e) {
    return function (t, r) {
      return a(t, Object.assign({ method: e }, r));
    };
  }
  function o(e) {
    return function (t, r, o) {
      return a(t, Object.assign({ method: e, data: r }, o));
    };
  }
  function n(e, t, r) {
    ...
    if (t && "object" == typeof t) {
      var o,
        a = {};
      if (e) for (o in e) a[r ? o.toLowerCase() : o] = e[o];
      for (o in t) {
  ...
  function a(e, r) {
    ...
    if (
      (a &&
        "object" == typeof a &&
        ((a = JSON.stringify(a)), (u["Content-Type"] = "application/json")),
      o.xsrfCookieName)
    )
      for (
        var f = document.cookie.split(/ *[;=] */), c = 0;
        c < f.length;
        c += 2
      )
    ...
    return (
      ...
      fetch(e, {
        ...
        return (o.validateStatus ? o.validateStatus(e.status) : e.ok)
          ? ("stream" === o.responseType
  ...
  return (
    ...
    (a.CancelToken = self.AbortController || Object),
    (a.create = e),
    a
  );
})();
