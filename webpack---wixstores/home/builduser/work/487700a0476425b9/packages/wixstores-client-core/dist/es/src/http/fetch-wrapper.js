...
var FetchAdapter = /** @class */ (function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.handleRawResponse(rawResponse, { request: request }),
            ];
          case 2:
            response = _b.sent();
            if (
              (_a = response.errors) === null || _a === void 0
                ? void 0
                : _a.length
            ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.handleRawResponse(rawResponse, {
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              this.handleRawResponse(rawResponse, {
                request: { url: url, body: data, options: options },
              }),
            ];
        }
      });
  ...
  FetchAdapter.prototype.handleRawResponse = function (rawResponse, data) {
    ...
    if (rawResponse.status !== 200) {
      throw new FetchError(
        "Got "
          .concat(rawResponse.statusText, " (")
          .concat(rawResponse.status, ") when requested: ")
          .concat(url),
        __assign(
          {
            response: __assign(__assign({}, rawResponse), { headers: headers }),
          },
          data
        )
      );
  ...
  FetchAdapter.prototype.processResponse = function (rawResponse, data) {
    ...
    var urlWithoutDomain =
      (_a = rawResponse.url) === null || _a === void 0
        ? void 0
        : _a.replace(/^.*\/\/[^/]+/, "");
    var requestUrl =
      (_b = data === null || data === void 0 ? void 0 : data.request) ===
        null || _b === void 0
        ? void 0
        : _b.url;
    var headers = {};
    if (
      (rawResponse === null || rawResponse === void 0
        ? void 0
        : rawResponse.headers) &&
      typeof rawResponse.headers.forEach === "function"
    ) {
