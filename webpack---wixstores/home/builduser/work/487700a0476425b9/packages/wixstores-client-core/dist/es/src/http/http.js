...
var Http = /** @class */ (function () {
  ...
  Http.prototype.post = function (urlTamplate, data, options) {
    ...
    var parsedUrl = new UrlParser(urlTamplate).generate(
  ...
  Http.prototype.get = function (url, options, withCacheKiller, withParser) {
    ...
    var queryParams = _.merge(
      {},
      options.queryParams,
      withCacheKiller ? { cacheKiller: Date.now() } : {}
    );
    var parsedUrl = withParser
      ? new UrlParser(url).generate(options.templateParams, queryParams)
      : url;
    var headers = this.getBaseHeaders();
  ...
  Http.prototype.delete = function (url, options) {
    ...
    var parsedUrl = new UrlParser(url).generate(
      options.templateParams,
      options.queryParams
    );
    var headers = this.getBaseHeaders();
...
var WixStoresHttp = /** @class */ (function (_super) {
  ...
  WixStoresHttp.prototype.getCurrencyHeader = function (currency) {
    var _a;
    return currency
      ? ((_a = {}), (_a[CURRENCY_HEADER_NAME] = currency), _a)
      : {};
  };
    ...
    return __assign(
      __assign(
        __assign(
          __assign(
            {},
            getHttpCommonHeaders(this.instanceResolver.getInstance())
          ),
          this.getCurrencyHeader(
            this.currencyResolver ? this.currencyResolver() : null
          )
        ),
