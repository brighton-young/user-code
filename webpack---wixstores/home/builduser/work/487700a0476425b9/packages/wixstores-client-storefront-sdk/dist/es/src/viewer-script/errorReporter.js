...
export var errorReporter = function (e) {
  sentryReporterInstance === null || sentryReporterInstance === void 0
    ? void 0
    : sentryReporterInstance.captureException(e);
  throw e;
};
    ...
    return _.reduce(
      ...
      function (result, value, key) {
        ...
        return __assign(
          __assign({}, result),
          ((_a = {}),
          (_a[key] = _.isFunction(value) ? wrapper(value) : value),
          _a)
        );
      },
      {}
...
export function createControllerRaven(
  platformServices,
  userContext,
  siteStore
) {
      ...
      siteStore.fetchAdapter.getHistory().forEach(
        /* istanbul ignore next: todo: test */ function (h) {
          ...
          raven.captureBreadcrumb({
            ...
            data: {
              body:
                (_a = JSON.stringify(h.data.body)) === null || _a === void 0
                  ? void 0
                  : _a.substr(0, 100),
              errors: h.data.rawResponse.errors,
              response:
                (_b = JSON.stringify(response)) === null || _b === void 0
                  ? void 0
                  : _b.substr(0, 300),
