...
export function createCartExports(_a) {
  ...
  var getCartActions = function (_a) {
    ...
    return new CartActions({ siteStore: siteStore, origin: origin });
  };
  ...
  var getMiniCartActions = function (siteStore) {
    return new MinicartActions({ siteStore: siteStore, origin: origin });
  };
  var getTinyCartActions = function (siteStore) {
    return new TinyCartActions({ siteStore: siteStore, origin: origin });
  };
  return {
    ...
    removeProduct: function (cartItemId, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            getCurrentCartByContext(context).then(function (_a) {
              var cartId = _a.cartId;
              //@ts-expect-error
              return getCartActions(context).removeItemFromCart(
                { cartId: cartId, cartItemId: Number(cartItemId) },
                options
              );
            }),
          ];
    ...
    addCustomItems: function (customItems) {
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            getCartActions(context).addCustomItemsToCart(customItems),
          ];
        });
      });
    },
    addProducts: function (items, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            getCartActions(context).addProductsToCart(items, options),
          ];
        });
      });
    },
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                getCartActions(context).addToCart({
    ...
    updateLineItemQuantity: function (cartItemId, quantity, options) {
      ...
      return getCurrentCartByContext(context).then(function (_a) {
        ...
        return getCartActions(context).updateLineItemQuantityInCart(
          { cartId: cartId, cartItemId: cartItemId, quantity: quantity },
          options
        );
      });
    },
