...
function getMappedUniqueList(arr, mapper) {
  return getUniques(
    (arr !== null && arr !== void 0 ? arr : []).map(mapper).filter(isDefined)
  ).toString();
}
var getUniques = function (arr) {
  return __spreadArray(
    [],
    __read(new Set(__spreadArray([], __read(arr), false))),
    false
  );
};
...
export var getAdditionalFeesPrice = function (cart) {
  ...
  return (
    ((_b =
      (_a = cart === null || cart === void 0 ? void 0 : cart.totals) === null ||
      _a === void 0
        ? void 0
        : _a.additionalFeesTotal) !== null && _b !== void 0
      ? _b
      : 0) * ONE_HUNDRED_THOUSAND
  );
};
export var getNumberOfAdditionalFees = function (cart) {
  ...
  /* istanbul ignore next */
  return (_b =
    (_a = cart === null || cart === void 0 ? void 0 : cart.additionalFees) ===
      null || _a === void 0
      ? void 0
