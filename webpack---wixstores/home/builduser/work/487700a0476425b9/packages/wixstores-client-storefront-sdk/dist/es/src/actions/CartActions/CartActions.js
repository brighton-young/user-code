...
var CartActions = /** @class */ (function (_super) {
  ...
  function CartActions(_a) {
    ...
    _this.commandsExecutor = new CommandsExecutor(
      Topology.CART_COMMANDS_URL,
      _this.siteStore.httpClient
    );
    _this.cartApi = new CartApi({ siteStore: siteStore, origin: origin });
    return _this;
  }
              ...
              __assign(
                {
                  ...
                  hasOptions:
                    Object.keys(
                      optionsSelectionsByNames !== null &&
                        optionsSelectionsByNames !== void 0
  ...
  CartActions.prototype.onAddToCartCompleted = function (
    cartSummary,
    addToCartAction,
    productId,
    onSuccess
  ...
  CartActions.prototype.mergeAddToCartItemsProductId = function (items) {
    return items.reduce(function (acc, item) {
      ...
      acc.push({
        productId:
          (_a = item.productId) !== null && _a !== void 0 ? _a : item.productID,
  ...
  CartActions.prototype.publishCart = function (
    cartSummary,
    reason,
    eventOptions
  ) {
    ...
    this.siteStore.pubSubManager.publish(
      CartEvents.CHANGED,
      __assign(__assign({}, publishableCart), {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.commandsExecutor.execute("BulkAddDetailedCustomAmountV2", {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.cartApi.applyCoupon(cartId, couponCode, userIdentifier),
            ];
          case 1:
            cartSummary = _b.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.cartApi.removeCoupon({ cartId: cartId, couponId: couponId }),
            ];
          case 1:
            cartSummary = _b.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              graphqlCartToCartSummary(graphqlCartResponse),
            ];
        }
      });
    });
