...
var SiteStore = /** @class */ (function (_super) {
  ...
  function SiteStore(_a, _b, wixCodeApi, platform, _c) {
    ...
    _this.biLogger = createOOIStoreFrontBILogger(
      user,
      _this.platformServices.bi.biToken,
      {
    ...
    _this.platformBiLogger = createOOIPlatformSiteBILogger(
      _this.platformServices.bi.biToken,
      {
        appName: appName,
        _msid: _this.msid,
    ...
    _this.baseUrls = _.mapValues(
      baseUrls,
      /* istanbul ignore next: todo: test */ function (url) {
  ...
  SiteStore.prototype.loadClientConfig = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          this.tryGetGqlAndFallbackToPost(
            this.resolveAbsoluteUrl(
              "/".concat(Topology.STOREFRONT_GRAPHQL_URL)
            ),
            {
            ...
            var data = _a.data;
            if (
              _this.experiments.enabled(SPECS.useCacheInEditorForSiteConfig)
            ) {
              _this.storage.memory.setItem(
                CacheKey.GET_CONFIG,
                JSON.stringify(data)
              );
            } else {
  ...
  Object.defineProperty(SiteStore.prototype, "storeCountry", {
    get: function () {
      ...
      if (this.windowApis.multilingual.isEnabled) {
        ...
        if (
          multilingualLanguage === null || multilingualLanguage === void 0
            ? void 0
            : multilingualLanguage.locale
        ) {
          locale = multilingualLanguage.locale;
        }
      }
      var regionalSettingsLanguageAndCountry =
        (_a =
          ...
          : "";
      var countryCode =
        (_b = regionalSettingsLanguageAndCountry[1]) !== null && _b !== void 0
          ? _b
          : "US";
  ...
  Object.defineProperty(SiteStore.prototype, "isOwner", {
    get: function () {
      return !!(
        this.bi &&
        this.usersApi.currentUser &&
        this.ownerId === this.usersApi.currentUser.id
      );
    },
    enumerable: false,
    configurable: true,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!(isUrlWithOverrides && conf.sectionId === PageMap.PRODUCT))
              return [3 /*break*/, 2];
            if (
              this.experiments.enabled(
                SPECS.NavigateToRelativeUrlWithCustomizedUrl
              )
            ) {
              this.location.to(
                this.customUrlApi.buildProductPageRelativeUrl({
                  slug: conf.state,
                })
              );
            } else {
              this.location.to(
                this.customUrlApi.buildProductPageUrl({ slug: conf.state })
              );
            }
            return [3 /*break*/, 4];
          case 2:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              (_a = siteStructure.pages.find(function (p) {
                return p.isHomePage;
              })) !== null && _a !== void 0
                ? _a
  ...
  SiteStore.prototype.getSiteStructure = function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            if (!((_a = this.siteStructure) !== null && _a !== void 0))
              return [3 /*break*/, 1];
            _b = _a;
            return [3 /*break*/, 3];
          case 1:
            ...
            return [
              4 /*yield*/,
              this.siteApis.getSiteStructure({
                includePageId: true,
  ...
  SiteStore.prototype.getUrl = function (sdkLink) {
    return this.links
      ? this.links.toUrl(sdkLink)
      : URLUtils.getUrlFromLink(sdkLink, []);
  };
        ...
        switch (_g.label) {
          ...
          case 2:
            return [
              ...
              ((_e.sdkLink =
                ((_f.pageId =
                  (_a = _g.sent()) === null || _a === void 0 ? void 0 : _a.id),
                (_f.type = "PageLink"),
                _f)),
          ...
          case 3:
            if (
              !(
                (_b = siteStructure.pages.find(function (p) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 1:
            _d.sent();
            this.customUrlApi = new CustomUrlApi(
              this.location.buildCustomizedUrl
            );
            _c = this;
          ...
          case 2:
            ...
            this.taxName =
              (_b =
                (_a = data.localeData) === null || _a === void 0
                  ? void 0
                  : _a.countries[0].properties) === null || _b === void 0
                ? void 0
                : _b.taxName;
            /* istanbul ignore if */
            if (!this.isSiteMode()) {
  ...
  SiteStore.prototype.handleExperiments = function (gqlExperiments) {
    ...
    var experimentsConductedByPlatform =
      this.platformServices.essentials.experiments.all();
    var experiments = this.platformServices.essentials.experiments.enabled(
      SPECS.ShouldUseOnlyPlatformExperiments
    )
      ? {}
      : gqlExperiments.reduce(function (acc, e) {
          ...
          return __assign(
            __assign({}, acc),
            ((_a = {}), (_a[e.name] = e.value), _a)
          );
        }, {});
    this.experiments = new Experiments({
      experiments: __assign(
        __assign({}, experiments),
        experimentsConductedByPlatform
      ),
    });
