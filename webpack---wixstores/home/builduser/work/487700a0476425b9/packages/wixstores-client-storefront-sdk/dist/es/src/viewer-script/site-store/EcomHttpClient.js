...
var EcomHttpClient = /** @class */ (function () {
  function EcomHttpClient(_a) {
    ...
    this.httpClient = new WixStoresHttp(
    ...
    if (multiLangHeader) {
      this.httpClient.addHeaders(
        ((_b = {}), (_b[MULTI_LANG_HEADER_NAME] = multiLangHeader), _b)
      );
    }
    /* istanbul ignore next: todo: test */
    if (this.csrfToken) {
      this.httpClient.addHeaders(
        ((_c = {}), (_c[CSRF_HEADER_NAME] = this.csrfToken), _c)
      );
    }
  }
  /* istanbul ignore next: todo: test */
  EcomHttpClient.prototype.tryGetGqlAndFallbackToPost = function (
    url,
    bodyData,
    options
  ) {
    ...
    var urlWithParams = ""
      .concat(url, "?o=")
      .concat(bodyData.operationName, "&s=")
      .concat(bodyData.source, "&q=")
      .concat(strippedQuery);
    if (bodyData.variables) {
      urlWithParams += "&v=".concat(
        encodeURIComponent(JSON.stringify(bodyData.variables))
      );
    }
  ...
  EcomHttpClient.prototype.resolveAbsoluteUrl = function (path) {
    ...
    var shouldUseOnlyBaseUrlAsOrigin =
      (_b =
        (_a = this.essentials) === null || _a === void 0
          ? void 0
          : _a.experiments) === null || _b === void 0
        ? void 0
        : _b.enabled(SPECS.ShouldUseOnlyBaseUrlAsOrigin);
    return this.isSSR() || shouldUseOnlyBaseUrlAsOrigin
      ? "".concat(this.getOrigin()).concat(path)
      : path;
  };
  ...
  EcomHttpClient.prototype.getMultiLangHeader = function () {
    ...
    return fields
      ? ""
          .concat(fields.lang, "|")
          .concat(fields.locale, "|")
          .concat(fields.isPrimaryLanguage.toString(), "|")
          .concat(this.storeId)
      : "";
  };
  ...
  EcomHttpClient.prototype.getCurrentlyUsedMultilingualLanguage = function () {
    var currentShortLang = this.wixCodeApi.window.multilingual.currentLanguage;
    return this.wixCodeApi.window.multilingual.siteLanguages.find(function (
      lang
    ) {
