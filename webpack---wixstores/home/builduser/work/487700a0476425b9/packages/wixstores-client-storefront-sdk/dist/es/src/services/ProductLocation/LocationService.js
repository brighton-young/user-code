...
var LocationService = /** @class */ (function () {
  function LocationService(_a) {
    ...
    this.customUrlApi = new CustomUrlApi(
      this.siteStore.location.buildCustomizedUrl
    );
  }
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.siteStore.getSectionUrl(this.sectionPage),
            ];
          case 1:
  ...
  LocationService.prototype.shouldAppendQueryString = function (
    includeQueryParams
  ) {
    return (
      includeQueryParams &&
      Object.keys(this.siteStore.location.query).length > 0
    );
  };
  LocationService.prototype.shouldUseCustomUrl = function () {
    return !!(this.isUrlWithOverrides && this.customUrlApi);
  };
  LocationService.prototype.buildUrlUsingSection = function (
    prefix,
    includeQueryParams
  ) {
    return !this.shouldAppendQueryString(includeQueryParams)
      ...
      : ""
          .concat(prefix, "?")
          .concat(queryToString(this.siteStore.location.query));
  };
  LocationService.prototype.getAbsoluteProductUrl = function (
    productUrlPart,
    includeQueryParams
  ) {
  ...
  LocationService.prototype.getRelativeProductUrl = function (
    productUrlPart,
    includeQueryParams
  ) {
    if (includeQueryParams === void 0) {
    ...
    if (this.shouldUseCustomUrl()) {
      ...
      var prefix = ""
        .concat(this.sectionUrl.relativeUrl, "/")
        .concat(productUrlPart);
      return this.buildUrlUsingSection(prefix, includeQueryParams);
    }
  };
  ...
  LocationService.prototype.getCustomizedUrlSegments = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          this.siteStore.siteApis.getCustomizedUrlSegments(currentUrl),
        ];
      });
    });
  };
