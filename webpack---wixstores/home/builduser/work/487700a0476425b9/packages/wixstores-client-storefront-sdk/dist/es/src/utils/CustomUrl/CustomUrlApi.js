...
var CustomUrlApi = /** @class */ (function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              !!this.absoluteUrlWithStub && !!this.relativeUrlWithStub,
            ];
          case 3:
            error_1 = _b.sent();
  ...
  CustomUrlApi.prototype.buildProductUrlTemplate = function (baseUrl) {
    ...
    return this.buildCustomizedUrl(
      STORES_FQDN.PRODUCT_PAGE,
      { slug: "abc" },
      baseUrl
        ? { pathPrefix: pathPrefix, baseUrl: baseUrl }
        : { pathPrefix: pathPrefix }
    ).then(function (url) {
      return url === null || url === void 0
        ? void 0
        : url.replace(/abc/g, "{stub}");
    });
  };
  CustomUrlApi.prototype.getProductWithStub = function (
    urlWithStub,
    urlSegments
  ) {
    if (!this.beenInit) {
