...
import { createWixcodeExports } from "./wixcode/createWixcodeExports";
...
function openPopup(config, siteStore) {
  ...
  siteStore.windowApis.openPersistentPopup(
    popupUrl,
    {
      theme: "BARE",
      width: "0%",
...
function getControllerFactory(controllerInstances, controllerFactories, type) {
  var ctrlFactory;
  if (
    controllerInstances === null || controllerInstances === void 0
      ? void 0
      : controllerInstances[type]
  ) {
    var controllerFunction = Object.keys(controllerInstances[type]).filter(
      function (k) {
    ...
    controllerFactories === null || controllerFactories === void 0
      ? void 0
      : controllerFactories[type]
  ) {
    // @ts-expect-error
  ...
  var iconLink =
    (_d =
      (_c =
        (_b =
          (_a =
            miniCartController === null || miniCartController === void 0
              ? void 0
              : miniCartController.config) === null || _a === void 0
            ? void 0
            : _a.style) === null || _b === void 0
          ? void 0
          : _b.styleParams) === null || _c === void 0
        ? void 0
        : _c.numbers) === null || _d === void 0
      ? void 0
      : _d.iconLink;
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          baseUrl =
            ctrlFactory.baseUrlKey &&
            context.siteStore.baseUrls[ctrlFactory.baseUrlKey];
          release =
            baseUrl &&
          ...
          setPropsWithErrorsReporting = function (p) {
            ...
            props.setProps(
              __assign(
                __assign({}, errorBoundaryProps),
                withErrorReporting(reportError)(p)
              )
            );
          };
...
export function createViewerScript(controllerFactories, options) {
  ...
  return withErrorReportingWrapping({
    initAppForPage: function (initParams, apis, namespaces, platformServices) {
      ...
      context.siteStore = new SiteStore(
        initParams,
        apis,
        namespaces,
        platformServices
      ...
      if (options.useWorkerRaven) {
        var sentryInstance = platformServices.monitoring.createMonitor(
          VIEWER_SCRIPT_DSN,
          function (data) {
        ...
        context.createMonitoring = createControllerRaven(
          platformServices,
    ...
    createControllers: function (controllerConfigs, controllerInstances) {
      var allowMobile =
        !context.siteStore.isMobile() ||
        context.siteStore.experiments.enabled(
          SPECS.AllowMobileTinyCartInViewer
        );
      var cartExists = context.siteStore.isCartExists;
      var isViewer =
        context.siteStore.isSiteMode() || context.siteStore.isPreviewMode();
      var loadMiniCart =
        context.siteStore.experiments.enabled(
          SPECS.AvoidLoadingMiniCartForDisabledSites
        ) && isMiniCartEnabledFromEditorSettings(controllerConfigs);
      var shouldOpenMiniCart =
        allowMobile && isViewer && isWorker() && cartExists;
      ...
      if (
        controllerConfigs.filter(function (c) {
          return c.type === StoresWidgetID.CART_ICON;
        }).length
      ) {
      ...
      return controllerConfigs.map(function (props) {
        // @ts-expect-error
        var ctrlFactory = getControllerFactory(
          controllerInstances,
          controllerFactories,
          props.type
        );
    ...
    exports: createWixcodeExports({ context: context, origin: "wixcode" }),
  });
}
