...
var ThankYouPageActions = /** @class */ (function (_super) {
  ...
  ThankYouPageActions.prototype.thankYouPageInfoToQueryParams = function (
    thankYouPageInfo
  ) {
    ...
    return __assign(
      {
        id: thankYouPageInfo.orderId
          ? thankYouPageInfo.orderId
          : thankYouPageInfo.subscriptionId,
  ...
  ThankYouPageActions.prototype.navigateToThankYouPage = function (
    origin,
    thankYouPageInfo
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        thankYouPageQueryParams =
          this.thankYouPageInfoToQueryParams(thankYouPageInfo);
        return [
          2 /*return*/,
