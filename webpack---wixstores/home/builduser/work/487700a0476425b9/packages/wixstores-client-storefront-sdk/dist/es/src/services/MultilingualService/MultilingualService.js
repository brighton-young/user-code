...
var MultilingualService = /** @class */ (function () {
  function MultilingualService(siteStore, publicData, widgetSettings) {
    ...
    var multiLangFields =
      (_a = this.siteStore.getMultiLangFields()) !== null && _a !== void 0
        ? _a
  ...
  Object.defineProperty(
    MultilingualService.prototype,
    "defaultMultiLangFields",
    {
      get: function () {
        return {
  ...
  MultilingualService.prototype.get = function (key) {
    if (this.isPrimaryLanguage) {
      ...
      var widgetSettingsTextsMap =
        this.widgetSettings[getLocaleNamespace(this.lang)];
      return widgetSettingsTextsMap === null ||
        widgetSettingsTextsMap === void 0
        ? void 0
        : widgetSettingsTextsMap[key];
    }
  };
  ...
  MultilingualService.prototype.getMergedTranslationsAsPublicData = function (
    freeTextFields
  ) {
