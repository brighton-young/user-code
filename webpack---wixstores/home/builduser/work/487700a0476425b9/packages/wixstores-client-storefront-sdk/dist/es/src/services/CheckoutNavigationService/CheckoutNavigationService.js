...
import { MultilingualService } from "../MultilingualService/MultilingualService";
import { getCheckoutOutOfViewerUrl } from "./getCheckoutOutOfViewerUrl";
import { isWorker } from "../../viewer-script/utils";
...
var CheckoutNavigationService = /** @class */ (function () {
  function CheckoutNavigationService(_a) {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              return [
                4 /*yield*/,
                this.siteStore.windowApis.openModal(url, {
                  width: width,
                  height: height,
        ...
        __assign(
          {
            ...
            consentPolicyHeader:
              _this.siteStore.usersApi._getConsentPolicyHeader(),
    ...
    this.isSubscriptionsPremiumFeature = function () {
      return (
        _.findIndex(_this.siteStore.premiumFeatures, function (feature) {
  ...
  CheckoutNavigationService.prototype.openModalByType = function (
    modalType,
    isEditorX,
    cart
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            {
              void this.siteStore.platformBiLogger.checkoutShowMerchantPaymentPopupSf(
                __assign(__assign({}, biParams), {
                  catalogAppId: getCatalogAppIds(cartSummary),
                })
              );
          ...
          case 3:
            {
              return [
                2 /*return*/,
                this.modalManger.openCantShipToDestination({
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.modalManger.openUpgradeToPremium({
              ...
              this.siteStore.platformBiLogger.checkoutNotAbleToAcceptPaymentsVisitorPopupSf(
                {
                  origin: this.origin,
                  additionalFeesPrice:
                    additionalFeesPrice * ONE_HUNDRED_THOUSAND,
          ...
          case 8:
            {
              ...
              return [
                2 /*return*/,
                this.modalManger.openUpgradeSubscriptions({
                  isEditorX: Boolean(isEditorX),
                }),
              ];
            }
  ...
  CheckoutNavigationService.prototype.checkIsAllowedToCheckout = function (_a) {
    ...
    var isLiveSite = !(
      this.siteStore.isPreviewMode() || this.siteStore.isEditorMode()
    );
    var needsAndHasPaymentMethods =
      !!hasCreatedPaymentMethods || !!fullPaymentOffline;
  ...
  CheckoutNavigationService.prototype.checkoutInfoToQueryParams = function (
    checkoutInfo
  ) {
    var _a;
    return __assign(
        ...
        __assign(
          __assign(
            __assign(
              __assign(
                {
                  ...
                  cashierPaymentId:
                    (_a = checkoutInfo.cashierPaymentId) !== null &&
                    _a !== void 0
                      ? _a
                      : "",
                  origin: this.origin,
              ...
              checkoutInfo.theme ? { theme: checkoutInfo.theme } : {}
            ),
  ...
  CheckoutNavigationService.prototype.navigateToCheckout = function (
    checkoutInfo
  ) {
    return __awaiter(this, void 0, void 0, function () {
      var shouldNavigateToOOV, urlParams;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.isEligibleForCheckoutInViewer()];
          case 1:
            shouldNavigateToOOV = !_a.sent();
            if (
              shouldNavigateToOOV &&
              !this.siteStore.experiments.enabled(
                SPECS.ShouldNotNavigateToCheckoutOOV
              )
            ) {
              return [
                2 /*return*/,
