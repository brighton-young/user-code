...
var BackInStockActions = /** @class */ (function (_super) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.siteStore.windowApis.openModal(
                BackInStockActions.getBackInStockModalUrl(modalOpenParam),
                modalOptions,
                this.compId
              ),
            ];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              response.backInStock.settings.isCollectingRequests,
            ];
        }
      });
    });
  ...
  BackInStockActions.prototype.trackFedOpsOpenModalStart = function () {
    var logger =
      this.siteStore.platformServices.fedOpsLoggerFactory.getLoggerForWidget({
        appName: BackInStockActions.BACK_IN_STOCK_MODAL_APP_NAME,
      });
    logger.interactionStarted(
      BackInStockActions.BACK_IN_STOCK_MODAL_OPENED_INTERACTION
    );
    logger.flush();
  };
  BackInStockActions.getBackInStockModalUrl = function (openParams) {
    ...
    try {
      for (
        var _b = __values(Object.entries(openParams)), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
  ...
  BackInStockActions.BACK_IN_STOCK_MODAL_APP_NAME =
    "back-in-stock-request-modal";
  BackInStockActions.BACK_IN_STOCK_MODAL_OPENED_INTERACTION =
    "open-request-modal";
